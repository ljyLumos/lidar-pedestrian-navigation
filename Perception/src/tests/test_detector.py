...
_Y_LIM = (-15, 15)
_INTERACTIVE = False
_SAVE_DIR = "./outputs/test_artifacts/test_detector"
...
def test_detector():
    ...
    # ckpt_file = os.environ.get("DROW_CKPT", "./checkpoints/ckpt_jrdb_ann_drow3_e40.pth")
    # d = Detector(
    #     ckpt_file, model="DROW3", gpu=True, stride=1, panoramic_scan=True
    # )

    ckpt_file = os.environ.get(
        "DR_SPAAM_CKPT", "./checkpoints/ckpt_jrdb_ann_dr_spaam_e20.pth"
    )
